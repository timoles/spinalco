				...
				<div class="fh5co-intro no-js-fullheight">
					<div class="fh5co-intro-text">
						...
						<!--<div class="fh5co-center-position">
							<h2 class="animate-box">A life without back pain for everyone</h2>
							<h3 class="animate-box">The easy way to prevention back pain</h3>
		...
		<!-- END #fh5co-hero -->
		 ...
		 <section id="fh5co-features">
			<div class="container">
                ...
                if ($werte["position"] == "1"){
                    //nicht ok
                    echo '<p>Happy for see for you</p>';
                    echo '<img src="images/red.jpg" height="300px"/></figure>';
                    echo '<p>You sit in the wrong position, please find your middle</p>';
                }
                else{
                    //ok
                    echo '<p>Happy for see for you</p>';
                    echo '<img src="images/green.jpg" height="300px"/></figure>';
                    echo '<p>You make everything perfect, go on!</p>';
                }
                }
             ...
             <a href="time.php"Active Sitting</a>
